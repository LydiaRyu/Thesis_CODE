...
cor_0.5_scad_result <- cbind(Accuracy,  AUC, F1, Recall,  Precision, Specificity, Sensitivity)

save(opt_lambda_scad_cor_0.5, file = 'opt_lambda_scad_cor_0.5.RData')
save(cor_0.5_scad_result, file = 'cor_0.5_scad_result.RData')

round(colMeans(cor_0.5_scad_result)*100, 2)
round(apply(cor_0.5_scad_result, 2, sd)/sqrt(20)*100 , 2)
